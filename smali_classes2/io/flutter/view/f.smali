...
.method static constructor <clinit>()V
    ...
    sget-object v0, Lio/flutter/view/f$g;->e:Lio/flutter/view/f$g;

    iget v0, v0, Lio/flutter/view/f$g;->a:I

    sget-object v1, Lio/flutter/view/f$g;->d:Lio/flutter/view/f$g;

    iget v1, v1, Lio/flutter/view/f$g;->a:I
    ...
    sget-object v0, Lio/flutter/view/f$i;->b:Lio/flutter/view/f$i;

    iget v0, v0, Lio/flutter/view/f$i;->a:I

    sget-object v1, Lio/flutter/view/f$i;->c:Lio/flutter/view/f$i;

    iget v1, v1, Lio/flutter/view/f$i;->a:I
...
.method public constructor <init>(Landroid/view/View;Lp8/a;Landroid/view/accessibility/AccessibilityManager;Landroid/content/ContentResolver;Lio/flutter/plugin/platform/r;)V
    .locals 7
    ...
    invoke-direct/range {v0 .. v6}, Lio/flutter/view/f;-><init>(Landroid/view/View;Lp8/a;Landroid/view/accessibility/AccessibilityManager;Landroid/content/ContentResolver;Lio/flutter/view/AccessibilityViewEmbedder;Lio/flutter/plugin/platform/r;)V

    return-void
.end method

.method public constructor <init>(Landroid/view/View;Lp8/a;Landroid/view/accessibility/AccessibilityManager;Landroid/content/ContentResolver;Lio/flutter/view/AccessibilityViewEmbedder;Lio/flutter/plugin/platform/r;)V
    .locals 4
    ...
    iput-object v1, p0, Lio/flutter/view/f;->v:Lp8/a$b;
    ...
    iput-object p2, p0, Lio/flutter/view/f;->b:Lp8/a;
    ...
    invoke-direct {p0}, Lio/flutter/view/f;->Z()V
...
.method private D(Lio/flutter/view/f$l;)Z
    .locals 3

    sget-object v0, Lio/flutter/view/f$i;->m:Lio/flutter/view/f$i;
...
.method private static synthetic F(Lio/flutter/view/f$l;Lio/flutter/view/f$l;)Z
    .locals 0
...
.method private static synthetic G(Lio/flutter/view/f$l;)Z
    .locals 1
...
.method private O(Lio/flutter/view/f$l;)V
    .locals 3
    ...
    invoke-direct {p0, v0}, Lio/flutter/view/f;->X(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v1}, Lio/flutter/view/f;->I(II)Landroid/view/accessibility/AccessibilityEvent;
    ...
    invoke-direct {p0, p1}, Lio/flutter/view/f;->U(Landroid/view/accessibility/AccessibilityEvent;)V

    :goto_0
    return-void
.end method

.method private P(Lio/flutter/view/f$l;ILandroid/os/Bundle;Z)Z
    .locals 4
    ...
    invoke-direct {p0, p1, v0, p4, p3}, Lio/flutter/view/f;->R(Lio/flutter/view/f$l;IZZ)V
    ...
    invoke-direct {p0, v2, v3}, Lio/flutter/view/f;->I(II)Landroid/view/accessibility/AccessibilityEvent;
    ...
    invoke-direct {p0, v2}, Lio/flutter/view/f;->U(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    sget-object v0, Lio/flutter/view/f$g;->u:Lio/flutter/view/f$g;
    ...
    iget-object p1, p0, Lio/flutter/view/f;->b:Lp8/a;

    invoke-static {p3}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object p3

    invoke-virtual {p1, p2, v0, p3}, Lp8/a;->c(ILio/flutter/view/f$g;Ljava/lang/Object;)V
    ...
    sget-object p4, Lio/flutter/view/f$g;->v:Lio/flutter/view/f$g;
    ...
    invoke-virtual {p1, p2, p4, p3}, Lp8/a;->c(ILio/flutter/view/f$g;Ljava/lang/Object;)V
    ...
    sget-object v0, Lio/flutter/view/f$g;->k:Lio/flutter/view/f$g;
    ...
    sget-object p4, Lio/flutter/view/f$g;->l:Lio/flutter/view/f$g;
...
.method private Q(Lio/flutter/view/f$l;ILandroid/os/Bundle;)Z
    .locals 2
    ...
    :goto_0
    iget-object v0, p0, Lio/flutter/view/f;->b:Lp8/a;

    sget-object v1, Lio/flutter/view/f$g;->w:Lio/flutter/view/f$g;

    invoke-virtual {v0, p2, v1, p3}, Lp8/a;->c(ILio/flutter/view/f$g;Ljava/lang/Object;)V
...
.method private R(Lio/flutter/view/f$l;IZZ)V
    .locals 3
...
.method private V()V
    ...
    invoke-virtual {v0, v1}, Lp8/a;->f(I)V
...
.method private W(I)V
    ...
    invoke-direct {p0, p1, v0}, Lio/flutter/view/f;->I(II)Landroid/view/accessibility/AccessibilityEvent;
...
.method private X(Ljava/lang/String;)V
    ...
    invoke-static {v0, p1}, Landroidx/core/view/l1;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method private Y(Z)V
    ...
    sget-object v0, Lio/flutter/view/f$f;->b:Lio/flutter/view/f$f;

    iget v0, v0, Lio/flutter/view/f$f;->a:I
    ...
    invoke-direct {p0}, Lio/flutter/view/f;->V()V
...
.method private Z()V
    ...
    sget-object v1, Lio/flutter/view/f$f;->e:Lio/flutter/view/f$f;

    iget v1, v1, Lio/flutter/view/f$f;->a:I
...
.method private b0(Lio/flutter/view/f$l;)Z
    .locals 2
    ...
    invoke-static {v0, v1}, Lio/flutter/view/f$l;->d(Lio/flutter/view/f$l;Li9/d;)Z
    ...
    invoke-static {p1, v0}, Lio/flutter/view/f$l;->d(Lio/flutter/view/f$l;Li9/d;)Z
...
.method private e0(Lio/flutter/view/f$l;)V
    .locals 6
...
.method static synthetic h(Lio/flutter/view/f;)V
    ...
    invoke-direct {p0}, Lio/flutter/view/f;->N()V
...
.method static synthetic i(Lio/flutter/view/f;II)Landroid/view/accessibility/AccessibilityEvent;
    ...
    invoke-direct {p0, p1, p2}, Lio/flutter/view/f;->I(II)Landroid/view/accessibility/AccessibilityEvent;
...
.method static synthetic l(Lio/flutter/view/f;)Lp8/a$b;
    .locals 0

    iget-object p0, p0, Lio/flutter/view/f;->v:Lp8/a$b;

    return-object p0
.end method

.method static synthetic m(Lio/flutter/view/f;)Lp8/a;
    .locals 0

    iget-object p0, p0, Lio/flutter/view/f;->b:Lp8/a;

    return-object p0
.end method

.method static synthetic n(Lio/flutter/view/f;Z)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/view/f;->Y(Z)V

    return-void
.end method

.method static synthetic o(Lio/flutter/view/f;I)Lio/flutter/view/f$l;
    .locals 0
...
.method static synthetic p(Lio/flutter/view/f;I)Lio/flutter/view/f$h;
    .locals 0
...
.method public S()V
    ...
    iget-object v1, p0, Lio/flutter/view/f;->b:Lp8/a;

    invoke-virtual {v1, v0}, Lp8/a;->g(Lp8/a$b;)V
...
.method public createAccessibilityNodeInfo(I)Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    invoke-direct {p0, v0}, Lio/flutter/view/f;->Y(Z)V
    ...
    invoke-direct {p0, v5}, Lio/flutter/view/f;->D(Lio/flutter/view/f$l;)Z
    ...
    :cond_c
    sget-object v8, Lio/flutter/view/f$i;->f:Lio/flutter/view/f$i;
    ...
    sget-object v9, Lio/flutter/view/f$i;->l:Lio/flutter/view/f$i;
    ...
    sget-object v9, Lio/flutter/view/f$i;->v:Lio/flutter/view/f$i;
    ...
    :goto_2
    sget-object v11, Lio/flutter/view/f$g;->l:Lio/flutter/view/f$g;
    ...
    :cond_11
    sget-object v11, Lio/flutter/view/f$g;->u:Lio/flutter/view/f$g;
    ...
    :cond_12
    sget-object v10, Lio/flutter/view/f$g;->v:Lio/flutter/view/f$g;
    ...
    sget-object v9, Lio/flutter/view/f$g;->e:Lio/flutter/view/f$g;
    ...
    sget-object v9, Lio/flutter/view/f$i;->t:Lio/flutter/view/f$i;
    ...
    :cond_29
    invoke-direct {p0, v5}, Lio/flutter/view/f;->b0(Lio/flutter/view/f$l;)Z
    ...
    sget-object v2, Lio/flutter/view/f$i;->r:Lio/flutter/view/f$i;
    ...
    sget-object v0, Lio/flutter/view/f$i;->s:Lio/flutter/view/f$i;
    ...
    invoke-static {v6, v0}, Ls/g;->a(Landroid/view/accessibility/AccessibilityNodeInfo;Z)V
...
.method d0(Ljava/nio/ByteBuffer;[Ljava/lang/String;[Ljava/nio/ByteBuffer;)V
    ...
    sget-object v3, Lio/flutter/view/f$i;->o:Lio/flutter/view/f$i;
    ...
    :cond_1
    sget-object v3, Lio/flutter/view/f$i;->g:Lio/flutter/view/f$i;
    ...
    invoke-direct {p0, v4}, Lio/flutter/view/f;->O(Lio/flutter/view/f$l;)V
    ...
    invoke-direct {p0, p3}, Lio/flutter/view/f;->e0(Lio/flutter/view/f$l;)V
    ...
    :cond_10
    invoke-direct {p0, v2}, Lio/flutter/view/f;->W(I)V
    ...
    invoke-direct {p0, p3, v0}, Lio/flutter/view/f;->I(II)Landroid/view/accessibility/AccessibilityEvent;
    ...
    :cond_16
    sget-object v5, Lio/flutter/view/f$g;->d:Lio/flutter/view/f$g;
    ...
    sget-object v6, Lio/flutter/view/f$i;->o:Lio/flutter/view/f$i;
    ...
    :cond_1c
    invoke-direct {p0, p3}, Lio/flutter/view/f;->U(Landroid/view/accessibility/AccessibilityEvent;)V

    :cond_1d
    sget-object p3, Lio/flutter/view/f$i;->q:Lio/flutter/view/f$i;
    ...
    invoke-direct {p0, p3}, Lio/flutter/view/f;->W(I)V
    ...
    sget-object p3, Lio/flutter/view/f$i;->d:Lio/flutter/view/f$i;
    ...
    sget-object p3, Lio/flutter/view/f$i;->f:Lio/flutter/view/f$i;
    ...
    invoke-direct {p0, p3, v4}, Lio/flutter/view/f;->I(II)Landroid/view/accessibility/AccessibilityEvent;
...
.method public performAction(IILandroid/os/Bundle;)Z
    ...
    iget-object p3, p0, Lio/flutter/view/f;->b:Lp8/a;

    sget-object v0, Lio/flutter/view/f$g;->s:Lio/flutter/view/f$g;
    ...
    invoke-virtual {p3, p1, v0, p2}, Lp8/a;->c(ILio/flutter/view/f$g;Ljava/lang/Object;)V

    return v5

    :sswitch_0
    iget-object p2, p0, Lio/flutter/view/f;->b:Lp8/a;

    sget-object p3, Lio/flutter/view/f$g;->j:Lio/flutter/view/f$g;

    invoke-virtual {p2, p1, p3}, Lp8/a;->b(ILio/flutter/view/f$g;)V

    return v5

    :sswitch_1
    invoke-direct {p0, v2, p1, p3}, Lio/flutter/view/f;->Q(Lio/flutter/view/f$l;ILandroid/os/Bundle;)Z
    ...
    sget-object v0, Lio/flutter/view/f$g;->m:Lio/flutter/view/f$g;
    ...
    invoke-virtual {p3, p1, p2}, Lp8/a;->b(ILio/flutter/view/f$g;)V
    ...
    :cond_8
    sget-object p2, Lio/flutter/view/f$g;->d:Lio/flutter/view/f$g;
    ...
    :sswitch_9
    invoke-direct {p0, v2, p1, p3, v3}, Lio/flutter/view/f;->P(Lio/flutter/view/f$l;ILandroid/os/Bundle;Z)Z
    ...
    :sswitch_a
    invoke-direct {p0, v2, p1, p3, v5}, Lio/flutter/view/f;->P(Lio/flutter/view/f$l;ILandroid/os/Bundle;Z)Z
    ...
    iget-object p3, p3, Lp8/a;->a:Lq8/a;

    invoke-virtual {p3, p2}, Lq8/a;->c(Ljava/lang/Object;)V
    ...
    sget-object p3, Lio/flutter/view/f$g;->b:Lio/flutter/view/f$g;
