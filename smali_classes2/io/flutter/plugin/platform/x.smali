...
.field private final t:Lio/flutter/embedding/android/c0;

.field private u:Z

.field private final v:Lp8/m$g;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/x;->v:Lp8/m$g;
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/x;->t:Lio/flutter/embedding/android/c0;

    return-void
.end method

.method static synthetic A(Lio/flutter/plugin/platform/x;Lio/flutter/plugin/platform/k;Lp8/m$d;)J
    .locals 0

    invoke-direct {p0, p1, p2}, Lio/flutter/plugin/platform/x;->J(Lio/flutter/plugin/platform/k;Lp8/m$d;)J
...
.method private H(Lio/flutter/plugin/platform/k;Lp8/m$d;)V
    .locals 1
...
.method private J(Lio/flutter/plugin/platform/k;Lp8/m$d;)J
    .locals 10
    ...
    invoke-static {v0}, Lio/flutter/plugin/platform/x;->e0(Lio/flutter/view/TextureRegistry;)Lio/flutter/plugin/platform/p;

    move-result-object v0

    iget-wide v1, p2, Lp8/m$d;->c:D

    invoke-direct {p0, v1, v2}, Lio/flutter/plugin/platform/x;->y0(D)I

    move-result v5

    iget-wide v1, p2, Lp8/m$d;->d:D
    ...
    iget v7, p2, Lp8/m$d;->a:I

    new-instance v9, Lio/flutter/plugin/platform/v;

    invoke-direct {v9, p0, p2}, Lio/flutter/plugin/platform/v;-><init>(Lio/flutter/plugin/platform/x;Lp8/m$d;)V
    ...
    invoke-interface {p1}, Lio/flutter/plugin/platform/k;->f()Landroid/view/View;
    ...
    iget-object v1, p2, Lp8/m$d;->b:Ljava/lang/String;
...
.method private R()V
    ...
    iget-object v1, p0, Lio/flutter/plugin/platform/x;->v:Lp8/m$g;

    invoke-interface {v1, v0}, Lp8/m$g;->h(I)V
...
.method private T(Lp8/m$d;)V
    .locals 3

    iget v0, p1, Lp8/m$d;->g:I
...
.method private U(Z)V
    ...
    iget-object v2, p0, Lio/flutter/plugin/platform/x;->d:Lio/flutter/embedding/android/s;

    invoke-virtual {v2, v4}, Lio/flutter/embedding/android/s;->m(Lio/flutter/embedding/android/l;)V

    invoke-virtual {v4}, Lio/flutter/embedding/android/l;->d()Z
    ...
    invoke-virtual {v4}, Lio/flutter/embedding/android/l;->c()V
...
.method private Y()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/x;->d:Lio/flutter/embedding/android/s;

    invoke-virtual {v0}, Lio/flutter/embedding/android/s;->p()V
...
.method private synthetic Z(Lp8/m$d;Landroid/view/View;Z)V
    .locals 0

    if-eqz p3, :cond_0

    iget-object p2, p0, Lio/flutter/plugin/platform/x;->g:Lp8/m;

    iget p1, p1, Lp8/m$d;->a:I

    invoke-virtual {p2, p1}, Lp8/m;->d(I)V
...
.method private synthetic a0(Lp8/m$d;Landroid/view/View;Z)V
    .locals 0
...
.method private static e0(Lio/flutter/view/TextureRegistry;)Lio/flutter/plugin/platform/p;
    .locals 3
    ...
    invoke-static {v2, v0}, Ld8/b;->e(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static synthetic f(Lio/flutter/plugin/platform/x;Lp8/m$d;Landroid/view/View;Z)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lio/flutter/plugin/platform/x;->a0(Lp8/m$d;Landroid/view/View;Z)V
...
.method private f0(Lio/flutter/plugin/platform/k;)V
    ...
    invoke-static {p1, v0}, Ld8/b;->e(Ljava/lang/String;Ljava/lang/String;)V

    return-void

    :cond_0
    invoke-interface {p1, v0}, Lio/flutter/plugin/platform/k;->c(Landroid/view/View;)V

    return-void
.end method

.method public static synthetic g(Lio/flutter/plugin/platform/x;Lp8/m$d;Landroid/view/View;Z)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lio/flutter/plugin/platform/x;->Z(Lp8/m$d;Landroid/view/View;Z)V
...
.method static synthetic j(Lio/flutter/plugin/platform/x;Lp8/m$d;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/x;->T(Lp8/m$d;)V
...
.method private t0()V
    ...
    iget-object v1, p0, Lio/flutter/plugin/platform/x;->d:Lio/flutter/embedding/android/s;
...
.method static synthetic u(Lio/flutter/plugin/platform/x;Lio/flutter/plugin/platform/k;Lp8/m$d;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lio/flutter/plugin/platform/x;->H(Lio/flutter/plugin/platform/k;Lp8/m$d;)V
...
.method static synthetic x(Lio/flutter/plugin/platform/x;)Lio/flutter/embedding/android/s;
    .locals 0

    iget-object p0, p0, Lio/flutter/plugin/platform/x;->d:Lio/flutter/embedding/android/s;
...
# virtual methods
.method public C(Landroid/content/Context;Lio/flutter/view/TextureRegistry;Le8/a;)V
    .locals 1
    ...
    invoke-direct {p1, p3}, Lp8/m;-><init>(Le8/a;)V

    iput-object p1, p0, Lio/flutter/plugin/platform/x;->g:Lp8/m;

    iget-object p2, p0, Lio/flutter/plugin/platform/x;->v:Lp8/m$g;

    invoke-virtual {p1, p2}, Lp8/m;->e(Lp8/m$g;)V
...
.method public E(Lio/flutter/embedding/engine/renderer/FlutterRenderer;)V
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/x;->b:Lio/flutter/embedding/android/a;

    return-void
.end method

.method public F(Lio/flutter/embedding/android/s;)V
    .locals 3

    iput-object p1, p0, Lio/flutter/plugin/platform/x;->d:Lio/flutter/embedding/android/s;
    ...
    invoke-interface {v0, v1}, Lio/flutter/plugin/platform/k;->c(Landroid/view/View;)V
...
.method public I(Lio/flutter/plugin/platform/k;Lp8/m$d;)J
    .locals 9
    ...
    invoke-static {v2}, Lio/flutter/plugin/platform/x;->e0(Lio/flutter/view/TextureRegistry;)Lio/flutter/plugin/platform/p;
    ...
    invoke-direct {v3, v4, v2}, Lio/flutter/plugin/platform/q;-><init>(Landroid/content/Context;Lio/flutter/plugin/platform/p;)V
    ...
    :goto_0
    iget-object v5, p0, Lio/flutter/plugin/platform/x;->b:Lio/flutter/embedding/android/a;
    ...
    invoke-direct {v0, p0, p2}, Lio/flutter/plugin/platform/u;-><init>(Lio/flutter/plugin/platform/x;Lp8/m$d;)V
    ...
    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/x;->f0(Lio/flutter/plugin/platform/k;)V
...
.method public K()Lio/flutter/embedding/engine/FlutterOverlaySurface;
    ...
    iget-object v3, p0, Lio/flutter/plugin/platform/x;->d:Lio/flutter/embedding/android/s;
...
.method public M(Lp8/m$d;Z)Lio/flutter/plugin/platform/k;
    .locals 3

    iget-object v0, p0, Lio/flutter/plugin/platform/x;->a:Lio/flutter/plugin/platform/n;

    iget-object v1, p1, Lp8/m$d;->b:Ljava/lang/String;
    ...
    iget-object v2, p1, Lp8/m$d;->i:Ljava/nio/ByteBuffer;

    if-eqz v2, :cond_0

    invoke-virtual {v0}, Lio/flutter/plugin/platform/l;->b()Lq8/i;

    move-result-object v1

    iget-object v2, p1, Lp8/m$d;->i:Ljava/nio/ByteBuffer;

    invoke-interface {v1, v2}, Lq8/i;->b(Ljava/nio/ByteBuffer;)Ljava/lang/Object;
    ...
    :goto_0
    iget v2, p1, Lp8/m$d;->a:I

    invoke-virtual {v0, p2, v2, v1}, Lio/flutter/plugin/platform/l;->a(Landroid/content/Context;ILjava/lang/Object;)Lio/flutter/plugin/platform/k;

    move-result-object p2

    invoke-interface {p2}, Lio/flutter/plugin/platform/k;->f()Landroid/view/View;

    move-result-object v0

    if-eqz v0, :cond_2

    iget v1, p1, Lp8/m$d;->g:I
    ...
    invoke-direct {p0, p2}, Lio/flutter/plugin/platform/x;->f0(Lio/flutter/plugin/platform/k;)V
    ...
    iget-object p1, p1, Lp8/m$d;->b:Ljava/lang/String;
...
.method public N()V
    ...
    invoke-virtual {v1}, Lio/flutter/embedding/android/l;->c()V

    invoke-virtual {v1}, Lio/flutter/embedding/android/l;->f()V
...
.method public O()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/x;->g:Lp8/m;

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    invoke-virtual {v0, v1}, Lp8/m;->e(Lp8/m$g;)V

    :cond_0
    invoke-virtual {p0}, Lio/flutter/plugin/platform/x;->N()V

    iput-object v1, p0, Lio/flutter/plugin/platform/x;->g:Lp8/m;
...
.method public P()V
    ...
    iput-object v1, p0, Lio/flutter/plugin/platform/x;->d:Lio/flutter/embedding/android/s;
    ...
    invoke-interface {v1}, Lio/flutter/plugin/platform/k;->g()V
...
.method X(I)V
    ...
    :cond_0
    invoke-interface {v0}, Lio/flutter/plugin/platform/k;->f()Landroid/view/View;
    ...
    iget-object v4, p0, Lio/flutter/plugin/platform/x;->b:Lio/flutter/embedding/android/a;
    ...
    iget-object p1, p0, Lio/flutter/plugin/platform/x;->d:Lio/flutter/embedding/android/s;
...
.method public k0(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
    ...
    invoke-interface {p3}, Lio/flutter/plugin/platform/k;->f()Landroid/view/View;
...
.method public l0()V
    ...
    invoke-virtual {v0, v1}, Lio/flutter/embedding/android/s;->A(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/android/s;->k()Z
...
.method public x0(FLp8/m$f;Z)Landroid/view/MotionEvent;
    .locals 20

    move-object/from16 v0, p2

    iget-wide v1, v0, Lp8/m$f;->p:J

    invoke-static {v1, v2}, Lio/flutter/embedding/android/c0$a;->c(J)Lio/flutter/embedding/android/c0$a;

    move-result-object v1

    move-object/from16 v2, p0

    iget-object v3, v2, Lio/flutter/plugin/platform/x;->t:Lio/flutter/embedding/android/c0;

    invoke-virtual {v3, v1}, Lio/flutter/embedding/android/c0;->b(Lio/flutter/embedding/android/c0$a;)Landroid/view/MotionEvent;

    move-result-object v1

    iget-object v3, v0, Lp8/m$f;->g:Ljava/lang/Object;
    ...
    iget-object v1, v0, Lp8/m$f;->b:Ljava/lang/Number;

    invoke-virtual {v1}, Ljava/lang/Number;->longValue()J

    move-result-wide v4

    iget-object v1, v0, Lp8/m$f;->c:Ljava/lang/Number;

    invoke-virtual {v1}, Ljava/lang/Number;->longValue()J

    move-result-wide v6

    iget v8, v0, Lp8/m$f;->d:I

    iget v9, v0, Lp8/m$f;->e:I

    iget v12, v0, Lp8/m$f;->h:I

    iget v13, v0, Lp8/m$f;->i:I

    iget v14, v0, Lp8/m$f;->j:F

    iget v15, v0, Lp8/m$f;->k:F

    iget v1, v0, Lp8/m$f;->l:I

    iget v3, v0, Lp8/m$f;->m:I

    iget v2, v0, Lp8/m$f;->n:I

    iget v0, v0, Lp8/m$f;->o:I
