...
.method public static synthetic j(Lio/flutter/plugin/platform/x$a;Lio/flutter/plugin/platform/h0;FLp8/m$b;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lio/flutter/plugin/platform/x$a;->k(Lio/flutter/plugin/platform/h0;FLp8/m$b;)V

    return-void
.end method

.method private synthetic k(Lio/flutter/plugin/platform/h0;FLp8/m$b;)V
    .locals 5
    ...
    invoke-direct {v0, v1, p1}, Lp8/m$c;-><init>(II)V

    invoke-interface {p3, v0}, Lp8/m$b;->a(Lp8/m$c;)V
...
.method public c(Lp8/m$f;)V
    .locals 4

    iget v0, p1, Lp8/m$f;->a:I
    ...
    invoke-virtual {v2, v1, p1, v3}, Lio/flutter/plugin/platform/x;->x0(FLp8/m$f;Z)Landroid/view/MotionEvent;
    ...
    :cond_1
    invoke-interface {v2}, Lio/flutter/plugin/platform/k;->f()Landroid/view/View;
    ...
    invoke-virtual {v0, v1, p1, v3}, Lio/flutter/plugin/platform/x;->x0(FLp8/m$f;Z)Landroid/view/MotionEvent;
...
.method public d(Lp8/m$d;)J
    .locals 4

    iget-object v0, p0, Lio/flutter/plugin/platform/x$a;->a:Lio/flutter/plugin/platform/x;

    invoke-static {v0, p1}, Lio/flutter/plugin/platform/x;->j(Lio/flutter/plugin/platform/x;Lp8/m$d;)V

    iget v0, p1, Lp8/m$d;->a:I
    ...
    invoke-static {v1}, Lio/flutter/plugin/platform/x;->x(Lio/flutter/plugin/platform/x;)Lio/flutter/embedding/android/s;
    ...
    invoke-virtual {v0, p1, v1}, Lio/flutter/plugin/platform/x;->M(Lp8/m$d;Z)Lio/flutter/plugin/platform/k;
    ...
    invoke-static {v2, v3}, Li9/h;->f(Landroid/view/View;[Ljava/lang/Class;)Z
    ...
    iget-object v1, p1, Lp8/m$d;->h:Lp8/m$d$a;

    sget-object v2, Lp8/m$d$a;->b:Lp8/m$d$a;

    if-ne v1, v2, :cond_1

    iget-object v1, p0, Lio/flutter/plugin/platform/x$a;->a:Lio/flutter/plugin/platform/x;

    invoke-static {v1, v0, p1}, Lio/flutter/plugin/platform/x;->u(Lio/flutter/plugin/platform/x;Lio/flutter/plugin/platform/k;Lp8/m$d;)V
    ...
    invoke-static {v1, v0, p1}, Lio/flutter/plugin/platform/x;->A(Lio/flutter/plugin/platform/x;Lio/flutter/plugin/platform/k;Lp8/m$d;)J
    ...
    invoke-virtual {v1, v0, p1}, Lio/flutter/plugin/platform/x;->I(Lio/flutter/plugin/platform/k;Lp8/m$d;)J
...
.method public e(Lp8/m$e;Lp8/m$b;)V
    .locals 4

    iget-object v0, p0, Lio/flutter/plugin/platform/x$a;->a:Lio/flutter/plugin/platform/x;

    iget-wide v1, p1, Lp8/m$e;->b:D
    ...
    invoke-direct {v3, p0, p1, v2, p2}, Lio/flutter/plugin/platform/w;-><init>(Lio/flutter/plugin/platform/x$a;Lio/flutter/plugin/platform/h0;FLp8/m$b;)V
    ...
    invoke-direct {p1, v0, v1}, Lp8/m$c;-><init>(II)V

    invoke-interface {p2, p1}, Lp8/m$b;->a(Lp8/m$c;)V
