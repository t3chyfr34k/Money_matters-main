...
.method private constructor <init>(Landroid/content/Context;Lio/flutter/plugin/platform/a;Landroid/hardware/display/VirtualDisplay;Lio/flutter/plugin/platform/k;Lio/flutter/plugin/platform/p;Landroid/view/View$OnFocusChangeListener;ILjava/lang/Object;)V
    .locals 7
    ...
    iput-object p5, p0, Lio/flutter/plugin/platform/h0;->f:Lio/flutter/plugin/platform/p;
...
.method public static b(Landroid/content/Context;Lio/flutter/plugin/platform/a;Lio/flutter/plugin/platform/k;Lio/flutter/plugin/platform/p;IIILjava/lang/Object;Landroid/view/View$OnFocusChangeListener;)Lio/flutter/plugin/platform/h0;
    .locals 12
    ...
    invoke-interface/range {p3 .. p5}, Lio/flutter/plugin/platform/p;->a(II)V
    ...
    invoke-direct/range {v2 .. v10}, Lio/flutter/plugin/platform/h0;-><init>(Landroid/content/Context;Lio/flutter/plugin/platform/a;Landroid/hardware/display/VirtualDisplay;Lio/flutter/plugin/platform/k;Lio/flutter/plugin/platform/p;Landroid/view/View$OnFocusChangeListener;ILjava/lang/Object;)V
...
.method private l(Landroid/view/View;IILjava/lang/Runnable;)V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/h0;->f:Lio/flutter/plugin/platform/p;

    invoke-interface {v0, p2, p3}, Lio/flutter/plugin/platform/p;->a(II)V
    ...
    iget-object p3, p0, Lio/flutter/plugin/platform/h0;->f:Lio/flutter/plugin/platform/p;
...
.method public j()V
    ...
    iget-object v5, p0, Lio/flutter/plugin/platform/h0;->f:Lio/flutter/plugin/platform/p;

    invoke-interface {v5}, Lio/flutter/plugin/platform/p;->getSurface()Landroid/view/Surface;
...
.method public k(IILjava/lang/Runnable;)V
    ...
    iget-object v2, v0, Lio/flutter/plugin/platform/h0;->f:Lio/flutter/plugin/platform/p;

    invoke-interface {v2, p1, p2}, Lio/flutter/plugin/platform/p;->a(II)V
    ...
    iget-object v6, v0, Lio/flutter/plugin/platform/h0;->f:Lio/flutter/plugin/platform/p;

    invoke-interface {v6}, Lio/flutter/plugin/platform/p;->getSurface()Landroid/view/Surface;
