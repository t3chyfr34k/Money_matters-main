...
.field private localizationPlugin:Lr8/b;
...
.method private handlePlatformMessageResponse(ILjava/nio/ByteBuffer;)V
    ...
    invoke-interface {v0, p1, p2}, Le8/f;->f(ILjava/nio/ByteBuffer;)V
...
.method public computePlatformResolvedLocale([Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lr8/b;
    ...
    :cond_4
    iget-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lr8/b;

    invoke-virtual {p1, v0}, Lr8/b;->c(Ljava/util/List;)Ljava/util/Locale;
...
.method public dispatchSemanticsAction(ILio/flutter/view/f$g;Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p3}, Lq8/s;->a(Ljava/lang/Object;)Ljava/nio/ByteBuffer;
    ...
    :goto_0
    iget p2, p2, Lio/flutter/view/f$g;->a:I
...
.method public getScaledFontSize(FI)F
    ...
    invoke-static {p2}, Lp8/p;->b(I)Landroid/util/DisplayMetrics;
...
.method public handlePlatformMessage(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
    ...
    invoke-interface/range {v0 .. v5}, Le8/f;->g(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
...
.method public requestDartDeferredLibrary(I)V
    ...
    invoke-interface {v0, p1, v1}, Lf8/a;->a(ILjava/lang/String;)V
...
.method public setDeferredComponentManager(Lf8/a;)V
    ...
    invoke-interface {p1, p0}, Lf8/a;->e(Lio/flutter/embedding/engine/FlutterJNI;)V

    :cond_0
    return-void
.end method

.method public setLocalizationPlugin(Lr8/b;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lr8/b;
...
.method public spawn(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)Lio/flutter/embedding/engine/FlutterJNI;
    ...
    invoke-static {p2, p3}, Li9/c;->a(ZLjava/lang/Object;)V
