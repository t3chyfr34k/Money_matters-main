...
.field private final c:Lj$/util/stream/v0;
...
.method constructor <init>(Lj$/util/stream/V;Lj$/util/Spliterator;)V
    ...
    iget-object p1, p1, Lj$/util/stream/V;->c:Lj$/util/stream/v0;

    iput-object p1, p0, Lj$/util/stream/V;->c:Lj$/util/stream/v0;

    return-void
.end method

.method constructor <init>(Lj$/util/stream/v0;Lj$/util/Spliterator;Lj$/util/stream/f2;)V
    .locals 1
...
.method public final compute()V
    ...
    iget-object v6, p0, Lj$/util/stream/V;->c:Lj$/util/stream/v0;

    invoke-virtual {v6}, Lj$/util/stream/v0;->d1()I

    move-result v6

    invoke-virtual {v5, v6}, Lj$/util/stream/S2;->o(I)Z

    move-result v5

    const/4 v6, 0x0

    iget-object v7, p0, Lj$/util/stream/V;->b:Lj$/util/stream/f2;
    ...
    invoke-interface {v7}, Lj$/util/stream/f2;->h()Z
    ...
    :cond_4
    :goto_2
    iget-object v1, v8, Lj$/util/stream/V;->c:Lj$/util/stream/v0;

    invoke-virtual {v1, v0, v7}, Lj$/util/stream/v0;->S0(Lj$/util/Spliterator;Lj$/util/stream/f2;)V
