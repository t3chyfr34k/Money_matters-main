...
.method public final synthetic allMatch(Ljava/util/function/IntPredicate;)Z
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->s(Lj$/util/function/O;)Z
...
.method public final synthetic anyMatch(Ljava/util/function/IntPredicate;)Z
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->D(Lj$/util/function/O;)Z
...
.method public final synthetic collect(Ljava/util/function/Supplier;Ljava/util/function/ObjIntConsumer;Ljava/util/function/BiConsumer;)Ljava/lang/Object;
    ...
    invoke-static {p2}, Lj$/util/function/z0;->a(Ljava/util/function/ObjIntConsumer;)Lj$/util/function/B0;
    ...
    invoke-interface {v0, p1, p2, p3}, Lj$/util/stream/IntStream;->B(Lj$/util/function/J0;Lj$/util/function/B0;Lj$/util/function/BiConsumer;)Ljava/lang/Object;
...
.method public final synthetic filter(Ljava/util/function/IntPredicate;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->b0(Lj$/util/function/O;)Lj$/util/stream/IntStream;
...
.method public final synthetic findAny()Ljava/util/OptionalInt;
    ...
    invoke-static {v0}, Lj$/util/j;->g(Lj$/util/l;)Ljava/util/OptionalInt;
...
.method public final synthetic flatMap(Ljava/util/function/IntFunction;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->T(Lj$/util/function/IntFunction;)Lj$/util/stream/IntStream;
...
.method public final synthetic map(Ljava/util/function/IntUnaryOperator;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->k(Lj$/util/function/Y;)Lj$/util/stream/IntStream;
...
.method public final synthetic mapToDouble(Ljava/util/function/IntToDoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    invoke-static {p1}, Lj$/util/function/P;->b(Ljava/util/function/IntToDoubleFunction;)Lj$/util/function/S;

    move-result-object p1

    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->Y(Lj$/util/function/S;)Lj$/util/stream/F;
...
.method public final synthetic mapToLong(Ljava/util/function/IntToLongFunction;)Ljava/util/stream/LongStream;
    ...
    invoke-static {p1}, Lj$/util/function/T;->a(Ljava/util/function/IntToLongFunction;)Lj$/util/function/V;

    move-result-object p1

    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->d(Lj$/util/function/V;)Lj$/util/stream/m0;
...
.method public final synthetic mapToObj(Ljava/util/function/IntFunction;)Ljava/util/stream/Stream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->Q(Lj$/util/function/IntFunction;)Lj$/util/stream/Stream;
...
.method public final synthetic noneMatch(Ljava/util/function/IntPredicate;)Z
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->u(Lj$/util/function/O;)Z
...
.method public final synthetic peek(Ljava/util/function/IntConsumer;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->d0(Lj$/util/function/K;)Lj$/util/stream/IntStream;
...
.method public final synthetic reduce(ILjava/util/function/IntBinaryOperator;)I
    ...
    invoke-interface {v0, p1, p2}, Lj$/util/stream/IntStream;->r(ILj$/util/function/G;)I
...
.method public final synthetic reduce(Ljava/util/function/IntBinaryOperator;)Ljava/util/OptionalInt;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->c0(Lj$/util/function/G;)Lj$/util/l;

    move-result-object p1

    invoke-static {p1}, Lj$/util/j;->g(Lj$/util/l;)Ljava/util/OptionalInt;
