...
.method public final synthetic collect(Ljava/util/function/Supplier;Ljava/util/function/BiConsumer;Ljava/util/function/BiConsumer;)Ljava/lang/Object;
    ...
    invoke-interface {v0, p1, p2, p3}, Lj$/util/stream/Stream;->G(Lj$/util/function/J0;Lj$/util/function/BiConsumer;Lj$/util/function/BiConsumer;)Ljava/lang/Object;
...
.method public final synthetic findAny()Ljava/util/Optional;
    ...
    invoke-interface {v0}, Lj$/util/stream/Stream;->findAny()Lj$/util/i;

    move-result-object v0

    invoke-static {v0}, Lj$/util/j;->e(Lj$/util/i;)Ljava/util/Optional;
...
.method public final synthetic findFirst()Ljava/util/Optional;
    ...
    invoke-interface {v0}, Lj$/util/stream/Stream;->findFirst()Lj$/util/i;
...
.method public final synthetic flatMapToDouble(Ljava/util/function/Function;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->n(Lj$/util/function/Function;)Lj$/util/stream/F;
...
.method public final synthetic flatMapToLong(Ljava/util/function/Function;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->a0(Lj$/util/function/Function;)Lj$/util/stream/m0;
...
.method public final synthetic mapToDouble(Ljava/util/function/ToDoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    invoke-static {p1}, Lj$/util/function/K0;->a(Ljava/util/function/ToDoubleFunction;)Lj$/util/function/M0;

    move-result-object p1

    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->i0(Lj$/util/function/M0;)Lj$/util/stream/F;
...
.method public final synthetic mapToInt(Ljava/util/function/ToIntFunction;)Ljava/util/stream/IntStream;
    ...
    invoke-static {p1}, Lj$/util/function/N0;->a(Ljava/util/function/ToIntFunction;)Lj$/util/function/P0;

    move-result-object p1

    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->I(Lj$/util/function/P0;)Lj$/util/stream/IntStream;
...
.method public final synthetic mapToLong(Ljava/util/function/ToLongFunction;)Ljava/util/stream/LongStream;
    ...
    invoke-static {p1}, Lj$/util/function/Q0;->a(Ljava/util/function/ToLongFunction;)Lj$/util/function/S0;

    move-result-object p1

    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->g0(Lj$/util/function/S0;)Lj$/util/stream/m0;
...
.method public final synthetic max(Ljava/util/Comparator;)Ljava/util/Optional;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->max(Ljava/util/Comparator;)Lj$/util/i;

    move-result-object p1

    invoke-static {p1}, Lj$/util/j;->e(Lj$/util/i;)Ljava/util/Optional;
...
.method public final synthetic min(Ljava/util/Comparator;)Ljava/util/Optional;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->min(Ljava/util/Comparator;)Lj$/util/i;
...
.method public final synthetic noneMatch(Ljava/util/function/Predicate;)Z
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->f0(Lj$/util/function/Predicate;)Z
...
.method public final synthetic reduce(Ljava/lang/Object;Ljava/util/function/BiFunction;Ljava/util/function/BinaryOperator;)Ljava/lang/Object;
    ...
    invoke-interface {v0, p1, p2, p3}, Lj$/util/stream/Stream;->l(Ljava/lang/Object;Lj$/util/function/BiFunction;Lj$/util/function/f;)Ljava/lang/Object;
...
.method public final synthetic reduce(Ljava/util/function/BinaryOperator;)Ljava/util/Optional;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->L(Lj$/util/function/f;)Lj$/util/i;
