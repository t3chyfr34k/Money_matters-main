...
.method constructor <init>(Lj$/util/stream/c;IJJ)V
    ...
    iput-wide p3, p0, Lj$/util/stream/l2;->t:J

    iput-wide p5, p0, Lj$/util/stream/l2;->u:J
...
.method static O1(Lj$/util/K;JJJ)Lj$/util/K;
    .locals 9
    ...
    invoke-direct/range {v3 .. v8}, Lj$/util/stream/s3;-><init>(Lj$/util/K;JJ)V
...
.method final E1(Lj$/util/Spliterator;Lj$/util/function/IntFunction;Lj$/util/stream/c;)Lj$/util/stream/E0;
    ...
    iget-wide v4, v9, Lj$/util/stream/l2;->t:J

    iget-wide v7, v9, Lj$/util/stream/l2;->u:J
    ...
    invoke-static {v6, v0, v10}, Lj$/util/stream/v0;->Q0(Lj$/util/stream/v0;Lj$/util/Spliterator;Z)Lj$/util/stream/C0;
    ...
    iget-wide v1, v9, Lj$/util/stream/l2;->t:J

    iget-wide v3, v9, Lj$/util/stream/l2;->u:J

    move-wide v5, v7

    invoke-static/range {v0 .. v6}, Lj$/util/stream/l2;->O1(Lj$/util/K;JJJ)Lj$/util/K;

    move-result-object v0

    invoke-static {p0, v0, v10}, Lj$/util/stream/v0;->Q0(Lj$/util/stream/v0;Lj$/util/Spliterator;Z)Lj$/util/stream/C0;
    ...
    iget-wide v11, v9, Lj$/util/stream/l2;->u:J
...
.method final F1(Lj$/util/stream/c;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    iget-wide v9, p0, Lj$/util/stream/l2;->t:J

    iget-wide p1, p0, Lj$/util/stream/l2;->u:J
    ...
    invoke-direct/range {v7 .. v12}, Lj$/util/stream/m3;-><init>(Lj$/util/K;JJ)V
    ...
    iget-wide v1, p0, Lj$/util/stream/l2;->t:J

    iget-wide v3, p0, Lj$/util/stream/l2;->u:J
    ...
    iget-wide v5, p0, Lj$/util/stream/l2;->t:J

    iget-wide v7, p0, Lj$/util/stream/l2;->u:J
