.class public final enum Lj$/time/chrono/x;
...
# static fields
.field public static final enum BCE:Lj$/time/chrono/x;

.field public static final enum CE:Lj$/time/chrono/x;

.field private static final synthetic a:[Lj$/time/chrono/x;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1, v2}, Lj$/time/chrono/x;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lj$/time/chrono/x;->BCE:Lj$/time/chrono/x;
    ...
    invoke-direct {v1, v3, v4}, Lj$/time/chrono/x;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lj$/time/chrono/x;->CE:Lj$/time/chrono/x;

    const/4 v3, 0x2

    new-array v3, v3, [Lj$/time/chrono/x;

    aput-object v0, v3, v2

    aput-object v1, v3, v4

    sput-object v3, Lj$/time/chrono/x;->a:[Lj$/time/chrono/x;
...
.method public static valueOf(Ljava/lang/String;)Lj$/time/chrono/x;
    .locals 1

    const-class v0, Lj$/time/chrono/x;
...
.method public static values()[Lj$/time/chrono/x;
    .locals 1

    sget-object v0, Lj$/time/chrono/x;->a:[Lj$/time/chrono/x;

    invoke-virtual {v0}, [Lj$/time/chrono/x;->clone()Ljava/lang/Object;
