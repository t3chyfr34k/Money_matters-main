...
.method private m(Landroid/content/Intent;)V
    ...
    invoke-direct {p1, v0}, Lcom/google/firebase/messaging/u0;-><init>(Landroid/os/Bundle;)V

    invoke-virtual {p0, p1}, Lcom/google/firebase/messaging/FirebaseMessagingService;->r(Lcom/google/firebase/messaging/u0;)V
...
.method private o(Landroid/content/Context;)Lc3/c;
    .locals 1

    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->f:Lc3/c;
    ...
    invoke-direct {v0, p1}, Lc3/c;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->f:Lc3/c;

    :cond_0
    iget-object p1, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->f:Lc3/c;
...
.method private p(Landroid/content/Intent;)V
    ...
    :cond_0
    invoke-direct {p0, p0}, Lcom/google/firebase/messaging/FirebaseMessagingService;->o(Landroid/content/Context;)Lc3/c;

    move-result-object v0

    new-instance v1, Lc3/a;

    invoke-direct {v1, p1}, Lc3/a;-><init>(Landroid/content/Intent;)V

    invoke-virtual {v0, v1}, Lc3/c;->b(Lc3/a;)Lcom/google/android/gms/tasks/Task;
...
.method private v(Landroid/content/Intent;)V
    ...
    invoke-direct {v1, p1}, Lcom/google/firebase/messaging/y0;-><init>(Ljava/lang/String;)V
...
.method protected e(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    invoke-virtual {p1}, Lcom/google/firebase/messaging/z0;->c()Landroid/content/Intent;
