...
.field private z:Lk0/b;


# direct methods
.method public constructor <init>(IIZIILandroid/os/Handler;Lk0/d$c;)V
    .locals 19
    ...
    iput-object v7, v0, Lk0/d;->s:Ljava/util/ArrayList;

    new-instance v7, Ljava/util/ArrayList;

    invoke-direct {v7}, Ljava/util/ArrayList;-><init>()V

    iput-object v7, v0, Lk0/d;->t:Ljava/util/ArrayList;

    new-instance v7, Ljava/util/ArrayList;

    invoke-direct {v7}, Ljava/util/ArrayList;-><init>()V

    iput-object v7, v0, Lk0/d;->u:Ljava/util/ArrayList;

    const/16 v7, 0x10

    new-array v7, v7, [F

    iput-object v7, v0, Lk0/d;->C:[F
    ...
    iput-object v12, v0, Lk0/d;->a:Landroid/media/MediaCodec;
    ...
    :cond_2
    iget-object v12, v0, Lk0/d;->a:Landroid/media/MediaCodec;

    invoke-virtual {v12}, Landroid/media/MediaCodec;->release()V

    iput-object v11, v0, Lk0/d;->a:Landroid/media/MediaCodec;
    ...
    :goto_2
    iput v4, v0, Lk0/d;->e:I

    move-object/from16 v14, p7

    iput-object v14, v0, Lk0/d;->b:Lk0/d$c;
    ...
    iput-object v14, v0, Lk0/d;->c:Landroid/os/HandlerThread;
    ...
    :cond_4
    iput-object v11, v0, Lk0/d;->c:Landroid/os/HandlerThread;
    ...
    iput-object v8, v0, Lk0/d;->d:Landroid/os/Handler;
    ...
    iput v1, v0, Lk0/d;->f:I

    iput v2, v0, Lk0/d;->g:I

    iput-boolean v10, v0, Lk0/d;->m:Z
    ...
    iput v1, v0, Lk0/d;->h:I

    iput v2, v0, Lk0/d;->i:I

    const/4 v4, 0x1

    iput v4, v0, Lk0/d;->j:I

    iput v4, v0, Lk0/d;->k:I

    goto :goto_a

    :cond_b
    iput v7, v0, Lk0/d;->h:I

    iput v14, v0, Lk0/d;->i:I

    iput v4, v0, Lk0/d;->j:I

    iput v9, v0, Lk0/d;->k:I

    :goto_a
    iget v4, v0, Lk0/d;->j:I

    iget v6, v0, Lk0/d;->k:I

    mul-int/2addr v4, v6

    iput v4, v0, Lk0/d;->l:I
    ...
    invoke-static {v4}, Lk0/c;->a(Landroid/media/MediaCodecInfo$EncoderCapabilities;)Landroid/util/Range;
    ...
    :goto_d
    iget-object v3, v0, Lk0/d;->a:Landroid/media/MediaCodec;

    new-instance v4, Lk0/d$d;

    invoke-direct {v4, v0}, Lk0/d$d;-><init>(Lk0/d;)V
    ...
    iput-object v3, v0, Lk0/d;->y:Landroid/view/Surface;
    ...
    :goto_10
    new-instance v5, Lk0/d$e;

    invoke-direct {v5, v0, v4}, Lk0/d$e;-><init>(Lk0/d;Z)V

    iput-object v5, v0, Lk0/d;->v:Lk0/d$e;

    if-eqz v4, :cond_13

    new-instance v4, Lk0/b;

    iget-object v5, v0, Lk0/d;->y:Landroid/view/Surface;

    invoke-direct {v4, v5}, Lk0/b;-><init>(Landroid/view/Surface;)V

    iput-object v4, v0, Lk0/d;->z:Lk0/b;

    invoke-virtual {v4}, Lk0/b;->f()V
    ...
    :goto_11
    invoke-direct {v5, v6}, Lk0/f;-><init>(I)V

    invoke-direct {v4, v5, v1, v2}, Lk0/a;-><init>(Lk0/f;II)V

    iput-object v4, v0, Lk0/d;->A:Lk0/a;

    invoke-virtual {v4}, Lk0/a;->c()I

    move-result v4

    iput v4, v0, Lk0/d;->B:I
    ...
    iget v5, v0, Lk0/d;->B:I

    invoke-direct {v3, v5, v4}, Landroid/graphics/SurfaceTexture;-><init>(IZ)V

    iput-object v3, v0, Lk0/d;->w:Landroid/graphics/SurfaceTexture;
    ...
    iget-object v3, v0, Lk0/d;->w:Landroid/graphics/SurfaceTexture;

    invoke-virtual {v3, v1, v2}, Landroid/graphics/SurfaceTexture;->setDefaultBufferSize(II)V

    new-instance v1, Landroid/view/Surface;

    iget-object v2, v0, Lk0/d;->w:Landroid/graphics/SurfaceTexture;

    invoke-direct {v1, v2}, Landroid/view/Surface;-><init>(Landroid/graphics/SurfaceTexture;)V

    iput-object v1, v0, Lk0/d;->x:Landroid/view/Surface;

    :cond_12
    iget-object v1, v0, Lk0/d;->z:Lk0/b;

    invoke-virtual {v1}, Lk0/b;->g()V

    goto :goto_13

    :cond_13
    iget-object v1, v0, Lk0/d;->y:Landroid/view/Surface;
    ...
    iget-object v2, v0, Lk0/d;->s:Ljava/util/ArrayList;

    iget v3, v0, Lk0/d;->f:I
    ...
    iget v3, v0, Lk0/d;->i:I

    const/4 v4, 0x0

    invoke-direct {v1, v4, v4, v2, v3}, Landroid/graphics/Rect;-><init>(IIII)V

    iput-object v1, v0, Lk0/d;->q:Landroid/graphics/Rect;

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, v0, Lk0/d;->p:Landroid/graphics/Rect;
...
.method private C(Z)V
    ...
    iget-object v0, p0, Lk0/d;->s:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-boolean v1, p0, Lk0/d;->o:Z

    or-int/2addr p1, v1

    iput-boolean p1, p0, Lk0/d;->o:Z

    iget-object p1, p0, Lk0/d;->s:Ljava/util/ArrayList;

    iget-object v1, p0, Lk0/d;->r:Ljava/nio/ByteBuffer;
    ...
    iput-object p1, p0, Lk0/d;->r:Ljava/nio/ByteBuffer;
...
.method private g()Ljava/nio/ByteBuffer;
    ...
    iget-object v1, p0, Lk0/d;->s:Ljava/util/ArrayList;
...
.method private i([B)V
    ...
    invoke-direct {p0}, Lk0/d;->g()Ljava/nio/ByteBuffer;
    ...
    iget-object p1, p0, Lk0/d;->t:Ljava/util/ArrayList;

    monitor-enter p1

    :try_start_0
    iget-object v1, p0, Lk0/d;->t:Ljava/util/ArrayList;
    ...
    iget-object p1, p0, Lk0/d;->d:Landroid/os/Handler;
...
.method private t()V
    ...
    iget v3, p0, Lk0/d;->h:I

    mul-int v4, v1, v3

    iget v5, p0, Lk0/d;->i:I

    mul-int v6, v0, v5

    iget-object v7, p0, Lk0/d;->p:Landroid/graphics/Rect;
    ...
    iget v4, p0, Lk0/d;->B:I

    sget-object v5, Lk0/f;->i:[F

    iget-object v6, p0, Lk0/d;->p:Landroid/graphics/Rect;

    invoke-virtual {v3, v4, v5, v6}, Lk0/a;->a(I[FLandroid/graphics/Rect;)V

    iget-object v3, p0, Lk0/d;->z:Lk0/b;

    const-wide/16 v4, 0x3e8

    iget v6, p0, Lk0/d;->n:I

    add-int/lit8 v7, v6, 0x1

    iput v7, p0, Lk0/d;->n:I

    invoke-direct {p0, v6}, Lk0/d;->m(I)J

    move-result-wide v6

    mul-long/2addr v6, v4

    invoke-virtual {v3, v6, v7}, Lk0/b;->i(J)V

    iget-object v3, p0, Lk0/d;->z:Lk0/b;

    invoke-virtual {v3}, Lk0/b;->j()Z
...
.method private u()Ljava/nio/ByteBuffer;
    ...
    iget-boolean v0, p0, Lk0/d;->o:Z

    const/4 v1, 0x0

    if-nez v0, :cond_1

    iget-object v0, p0, Lk0/d;->r:Ljava/nio/ByteBuffer;

    if-nez v0, :cond_1

    iget-object v0, p0, Lk0/d;->t:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v2, p0, Lk0/d;->t:Ljava/util/ArrayList;
    ...
    :goto_0
    iput-object v2, p0, Lk0/d;->r:Ljava/nio/ByteBuffer;
...
.method public E()V
    ...
    iget-object v0, p0, Lk0/d;->a:Landroid/media/MediaCodec;
...
.method public F()V
    ...
    iget-object v0, p0, Lk0/d;->v:Lk0/d$e;

    const-wide/16 v1, 0x0

    invoke-virtual {v0, v1, v2}, Lk0/d$e;->c(J)V
    ...
    invoke-direct {p0, v0}, Lk0/d;->i([B)V
...
.method G()V
    ...
    iput-object v1, p0, Lk0/d;->a:Landroid/media/MediaCodec;
    ...
    :try_start_0
    iput-boolean v2, p0, Lk0/d;->o:Z

    iget-object v2, p0, Lk0/d;->s:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v2}, Lk0/a;->e(Z)V

    iput-object v1, p0, Lk0/d;->A:Lk0/a;

    :cond_1
    iget-object v0, p0, Lk0/d;->z:Lk0/b;

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Lk0/b;->h()V

    iput-object v1, p0, Lk0/d;->z:Lk0/b;

    :cond_2
    iget-object v0, p0, Lk0/d;->w:Landroid/graphics/SurfaceTexture;

    if-eqz v0, :cond_3

    invoke-virtual {v0}, Landroid/graphics/SurfaceTexture;->release()V

    iput-object v1, p0, Lk0/d;->w:Landroid/graphics/SurfaceTexture;
...
.method public close()V
    ...
    iget-object v0, p0, Lk0/d;->d:Landroid/os/Handler;

    new-instance v1, Lk0/d$b;

    invoke-direct {v1, p0}, Lk0/d$b;-><init>(Lk0/d;)V
...
.method public h(Landroid/graphics/Bitmap;)V
    ...
    iget v1, p0, Lk0/d;->n:I

    invoke-direct {p0, v1}, Lk0/d;->m(I)J
    ...
    invoke-direct {p0, v3}, Lk0/d;->m(I)J

    move-result-wide v3

    invoke-virtual {v0, v1, v2, v3, v4}, Lk0/d$e;->d(JJ)Z
    ...
    :cond_1
    invoke-virtual {v0}, Lk0/b;->f()V

    iget-object v0, p0, Lk0/d;->A:Lk0/a;

    iget v1, p0, Lk0/d;->B:I

    invoke-virtual {v0, v1, p1}, Lk0/a;->d(ILandroid/graphics/Bitmap;)V

    invoke-direct {p0}, Lk0/d;->t()V

    iget-object p1, p0, Lk0/d;->z:Lk0/b;

    invoke-virtual {p1}, Lk0/b;->g()V
...
.method public onFrameAvailable(Landroid/graphics/SurfaceTexture;)V
    ...
    iget-object v2, p0, Lk0/d;->v:Lk0/d$e;
    ...
    invoke-virtual {v2, v0, v1, v3, v4}, Lk0/d$e;->d(JJ)Z
...
.method v()V
    ...
    :cond_0
    :goto_0
    invoke-direct {p0}, Lk0/d;->u()Ljava/nio/ByteBuffer;

    move-result-object v0

    if-eqz v0, :cond_6

    iget-object v1, p0, Lk0/d;->u:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lk0/d;->a:Landroid/media/MediaCodec;
    ...
    iget v4, p0, Lk0/d;->k:I

    rem-int v5, v3, v4

    mul-int/2addr v5, v2

    iget v7, p0, Lk0/d;->i:I

    div-int/2addr v3, v4

    iget v4, p0, Lk0/d;->j:I

    rem-int/2addr v3, v4

    mul-int/2addr v3, v7

    iget-object v4, p0, Lk0/d;->p:Landroid/graphics/Rect;
    ...
    iget-object v5, p0, Lk0/d;->q:Landroid/graphics/Rect;

    invoke-static/range {v0 .. v5}, Lk0/d;->n(Ljava/nio/ByteBuffer;Landroid/media/Image;IILandroid/graphics/Rect;Landroid/graphics/Rect;)V

    :cond_2
    iget-object v7, p0, Lk0/d;->a:Landroid/media/MediaCodec;
    ...
    :goto_2
    iget v0, p0, Lk0/d;->n:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, Lk0/d;->n:I

    invoke-direct {p0, v0}, Lk0/d;->m(I)J
    ...
    :cond_5
    invoke-direct {p0, v14}, Lk0/d;->C(Z)V
