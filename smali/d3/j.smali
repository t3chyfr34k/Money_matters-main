...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ld3/j;->b:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Ld3/j;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(Landroid/content/Context;I)V
    ...
    invoke-virtual {v0, p0, p1}, Ld3/f;->h(Landroid/content/Context;I)I
    ...
    invoke-virtual {v0, p0, p1, v1}, Ld3/f;->b(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-direct {v0, p1, v1, p0}, Ld3/h;-><init>(ILjava/lang/String;Landroid/content/Intent;)V
...
.method public static c(I)Ljava/lang/String;
    ...
    invoke-static {p0}, Ld3/b;->M(I)Ljava/lang/String;
...
.method public static f(Landroid/content/Context;)Z
    ...
    invoke-virtual {v0, v3, v4}, Ln3/d;->e(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    invoke-static {v0, v1}, Ld3/k;->e(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-nez p0, :cond_0

    invoke-static {v0, v2}, Ld3/k;->e(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-eqz p0, :cond_0

    sput-boolean v2, Ld3/j;->c:Z

    goto :goto_0

    :cond_0
    sput-boolean v1, Ld3/j;->c:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_1
    :goto_2
    sget-boolean p0, Ld3/j;->c:Z

    if-nez p0, :cond_3

    invoke-static {}, Ll3/i;->b()Z
...
.method public static g(Landroid/content/Context;I)I
    ...
    sget-object v1, Ld3/j;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_3
    :goto_1
    invoke-static {p0}, Ll3/i;->d(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Ll3/i;->f(Landroid/content/Context;)Z
    ...
    invoke-static {v9, v3}, Ld3/k;->e(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {v8, v3}, Ld3/k;->e(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {p0}, Ll3/t;->a(I)I

    move-result p0

    invoke-static {p1}, Ll3/t;->a(I)I
...
.method public static h(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Ld3/j;->l(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static k(Landroid/content/Context;ILjava/lang/String;)Z
    ...
    invoke-static {p0, p1, p2}, Ll3/r;->b(Landroid/content/Context;ILjava/lang/String;)Z
...
.method static l(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Ld3/j;->i(Landroid/content/Context;)Z
