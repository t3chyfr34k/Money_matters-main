...
# direct methods
.method constructor <init>(Landroid/database/sqlite/SQLiteDatabase;Lw5/o;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lw5/a4;->a:Landroid/database/sqlite/SQLiteDatabase;

    iput-object p2, p0, Lw5/a4;->b:Lw5/o;
...
.method private A()V
    ...
    new-instance v1, Lw5/t3;

    invoke-direct {v1, p0}, Lw5/t3;-><init>(Lw5/a4;)V

    invoke-direct {p0, v0, v1}, Lw5/a4;->N([Ljava/lang/String;Ljava/lang/Runnable;)V
...
.method private B()V
    ...
    new-instance v1, Lw5/k3;

    invoke-direct {v1, p0}, Lw5/k3;-><init>(Lw5/a4;)V
...
.method private C()V
    ...
    new-instance v1, Lw5/v3;

    invoke-direct {v1, p0}, Lw5/v3;-><init>(Lw5/a4;)V
...
.method private D()V
    ...
    new-instance v1, Lw5/i3;

    invoke-direct {v1, p0}, Lw5/i3;-><init>(Lw5/a4;)V
...
.method private E()V
    ...
    new-instance v1, Lw5/l3;

    invoke-direct {v1, p0}, Lw5/l3;-><init>(Lw5/a4;)V
    ...
    iget-object v1, p0, Lw5/a4;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    new-instance v2, Lw5/m3;

    invoke-direct {v2, v0, v1}, Lw5/m3;-><init>(Lw5/u0$a;Landroid/database/sqlite/SQLiteStatement;)V
    ...
    invoke-direct {v0, v1, v3}, Lw5/b3$d;-><init>(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V

    new-instance v1, Lw5/n3;

    invoke-direct {v1, v2}, Lw5/n3;-><init>(Lb6/n;)V
    ...
    new-instance v1, Lw5/o3;

    invoke-direct {v1, v2}, Lw5/o3;-><init>(Lb6/n;)V
...
.method private F()V
    ...
    invoke-direct {v0, v1, v2}, Lw5/b3$d;-><init>(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V

    new-instance v1, Lw5/y3;

    invoke-direct {v1, p0}, Lw5/y3;-><init>(Lw5/a4;)V
...
.method private G()V
    ...
    invoke-direct {p0, v0}, Lw5/a4;->m0(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Lw5/a4;->a:Landroid/database/sqlite/SQLiteDatabase;
...
.method private H()V
    ...
    iget-object v2, p0, Lw5/a4;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    new-instance v3, Lw5/p3;

    invoke-direct {v3, v1, v2}, Lw5/p3;-><init>([ZLandroid/database/sqlite/SQLiteStatement;)V

    invoke-virtual {v0, v3}, Lw5/b3$d;->e(Lb6/n;)I
...
.method private J()V
    ...
    new-instance v1, Lw5/z3;

    invoke-direct {v1}, Lw5/z3;-><init>()V
    ...
    new-instance v5, Lw5/b3$d;

    iget-object v6, p0, Lw5/a4;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct {v5, v6, v7}, Lw5/b3$d;-><init>(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v6}, Lw5/b3$d;->b([Ljava/lang/Object;)Lw5/b3$d;
    ...
    new-instance v6, Lw5/j3;

    invoke-direct {v6, v1, v0, v3, v4}, Lw5/j3;-><init>([ZLandroid/database/sqlite/SQLiteStatement;J)V

    invoke-virtual {v5, v6}, Lw5/b3$d;->e(Lb6/n;)I
...
.method private M()Z
    ...
    invoke-direct {p0, v0, v1}, Lw5/a4;->l0(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v1

    const-string v2, "read_time_nanos"

    invoke-direct {p0, v0, v2}, Lw5/a4;->l0(Ljava/lang/String;Ljava/lang/String;)Z
...
.method private N([Ljava/lang/String;Ljava/lang/Runnable;)V
    ...
    invoke-direct {p0, v4}, Lw5/a4;->m0(Ljava/lang/String;)Z
    ...
    invoke-static {v0, p1, p2}, Lb6/w;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private static synthetic V(Lw5/u0$a;Landroid/database/sqlite/SQLiteStatement;Lx5/u;)V
    .locals 1

    invoke-virtual {p0, p2}, Lw5/u0$a;->a(Lx5/u;)Z
    ...
    invoke-virtual {p2}, Lx5/e;->s()Lx5/e;
    ...
    invoke-static {p2}, Lw5/f;->c(Lx5/e;)Ljava/lang/String;
...
.method private static synthetic W(Lb6/n;Landroid/database/Cursor;)V
    .locals 1
...
.method private static synthetic X(Lb6/n;Landroid/database/Cursor;)V
    .locals 1
...
.method private synthetic Z(Landroid/database/Cursor;)V
    ...
    invoke-virtual {p1}, Lcom/google/protobuf/z;->c0()Lcom/google/protobuf/z$a;

    move-result-object p1

    check-cast p1, Lz5/c$b;

    invoke-virtual {p1}, Lz5/c$b;->G()Lz5/c$b;
    ...
    iget-object v3, p0, Lw5/a4;->a:Landroid/database/sqlite/SQLiteDatabase;
...
.method public static synthetic a(Lw5/a4;)V
    .locals 0

    invoke-direct {p0}, Lw5/a4;->T()V
...
.method private static synthetic a0([ZLandroid/database/sqlite/SQLiteStatement;Landroid/database/Cursor;)V
    ...
    invoke-static {p0}, Lw5/f;->b(Ljava/lang/String;)Lx5/u;
    ...
    invoke-static {v1, p1, p0}, Lb6/b;->d(ZLjava/lang/String;[Ljava/lang/Object;)V

    return-void
.end method

.method public static synthetic b(Lw5/a4;)V
    .locals 0

    invoke-direct {p0}, Lw5/a4;->U()V
...
.method public static synthetic c(Lw5/a4;)V
    .locals 0

    invoke-direct {p0}, Lw5/a4;->R()V
...
.method public static synthetic d(Landroid/database/Cursor;)Ljava/lang/Long;
    ...
    invoke-static {p0}, Lw5/a4;->b0(Landroid/database/Cursor;)Ljava/lang/Long;
...
.method private synthetic d0(Ljava/lang/String;Landroid/database/Cursor;)V
    ...
    invoke-direct {p0, p1, p2}, Lw5/a4;->h0(Ljava/lang/String;I)V
...
.method public static synthetic e([ZLandroid/database/sqlite/SQLiteStatement;Landroid/database/Cursor;)V
    ...
    invoke-static {p0, p1, p2}, Lw5/a4;->a0([ZLandroid/database/sqlite/SQLiteStatement;Landroid/database/Cursor;)V
...
.method private synthetic e0(Landroid/database/Cursor;)V
    ...
    new-instance p1, Lw5/b3$d;

    iget-object v5, p0, Lw5/a4;->a:Landroid/database/sqlite/SQLiteDatabase;

    const-string v6, "SELECT batch_id FROM mutations WHERE uid = ? AND batch_id <= ?"

    invoke-direct {p1, v5, v6}, Lw5/b3$d;-><init>(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v5}, Lw5/b3$d;->b([Ljava/lang/Object;)Lw5/b3$d;

    move-result-object p1

    new-instance v0, Lw5/q3;

    invoke-direct {v0, p0, v1}, Lw5/q3;-><init>(Lw5/a4;Ljava/lang/String;)V
...
.method public static synthetic f(Lw5/u0$a;Landroid/database/sqlite/SQLiteStatement;Lx5/u;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lw5/a4;->V(Lw5/u0$a;Landroid/database/sqlite/SQLiteStatement;Lx5/u;)V
...
.method private synthetic f0(Landroid/database/Cursor;)V
    ...
    iget-object v3, p0, Lw5/a4;->b:Lw5/o;

    invoke-virtual {v3, p1}, Lw5/o;->h(Lz5/c;)Lw5/j4;
...
.method public static synthetic g(Lw5/a4;)V
    .locals 0

    invoke-direct {p0}, Lw5/a4;->Y()V
...
.method private g0()V
    ...
    new-instance v1, Lw5/w3;

    invoke-direct {v1, p0}, Lw5/w3;-><init>(Lw5/a4;)V
...
.method public static synthetic h(Lb6/n;Landroid/database/Cursor;)V
    .locals 0

    invoke-static {p0, p1}, Lw5/a4;->W(Lb6/n;Landroid/database/Cursor;)V
...
.method public static synthetic i(Lw5/a4;)V
    .locals 0

    invoke-direct {p0}, Lw5/a4;->P()V
...
.method private i0()V
    ...
    new-instance v1, Lw5/r3;

    invoke-direct {v1, p0}, Lw5/r3;-><init>(Lw5/a4;)V
...
.method public static synthetic j(Lw5/a4;Landroid/database/Cursor;)V
    .locals 0

    invoke-direct {p0, p1}, Lw5/a4;->Z(Landroid/database/Cursor;)V

    return-void
.end method

.method public static synthetic k(Lw5/a4;)V
    .locals 0

    invoke-direct {p0}, Lw5/a4;->O()V

    return-void
.end method

.method public static synthetic l(Lw5/a4;)V
    .locals 0

    invoke-direct {p0}, Lw5/a4;->Q()V
...
.method private l0(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1}, Lw5/a4;->L(Ljava/lang/String;)Ljava/util/List;
...
.method public static synthetic m(Lw5/a4;Landroid/database/Cursor;)V
    .locals 0

    invoke-direct {p0, p1}, Lw5/a4;->f0(Landroid/database/Cursor;)V
...
.method public static synthetic n(Lw5/a4;Landroid/database/Cursor;)V
    .locals 0

    invoke-direct {p0, p1}, Lw5/a4;->e0(Landroid/database/Cursor;)V
...
.method public static synthetic o([ZLandroid/database/sqlite/SQLiteStatement;JLandroid/database/Cursor;)V
    ...
    invoke-static {p0, p1, p2, p3, p4}, Lw5/a4;->c0([ZLandroid/database/sqlite/SQLiteStatement;JLandroid/database/Cursor;)V

    return-void
.end method

.method public static synthetic p(Lw5/a4;Ljava/lang/String;Landroid/database/Cursor;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lw5/a4;->d0(Ljava/lang/String;Landroid/database/Cursor;)V

    return-void
.end method

.method public static synthetic q(Lb6/n;Landroid/database/Cursor;)V
    .locals 0

    invoke-static {p0, p1}, Lw5/a4;->X(Lb6/n;Landroid/database/Cursor;)V

    return-void
.end method

.method public static synthetic r(Lw5/a4;)V
    .locals 0

    invoke-direct {p0}, Lw5/a4;->S()V
...
.method private x()V
    ...
    new-instance v1, Lw5/x3;

    invoke-direct {v1, p0}, Lw5/x3;-><init>(Lw5/a4;)V
...
.method private y()V
    ...
    new-instance v1, Lw5/s3;

    invoke-direct {v1, p0}, Lw5/s3;-><init>(Lw5/a4;)V
...
.method private z()V
    ...
    new-instance v1, Lw5/u3;

    invoke-direct {v1, p0}, Lw5/u3;-><init>(Lw5/a4;)V
...
.method j0(I)V
    ...
    invoke-virtual {p0, p1, v0}, Lw5/a4;->k0(II)V
...
.method k0(II)V
    ...
    invoke-direct {p0}, Lw5/a4;->B()V

    invoke-direct {p0}, Lw5/a4;->D()V

    invoke-direct {p0}, Lw5/a4;->C()V
    ...
    invoke-direct {p0}, Lw5/a4;->K()V

    invoke-direct {p0}, Lw5/a4;->w()V
    ...
    invoke-direct {p0}, Lw5/a4;->A()V

    invoke-direct {p0}, Lw5/a4;->y()V

    sget-object v4, Lw5/f1;->b:Ljava/lang/String;

    invoke-direct {p0, v4}, Lw5/a4;->t(Ljava/lang/String;)V
    ...
    invoke-static {p1, p2, v3}, Lb6/w;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
