...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lk6/c;->d:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lk6/c;->e:Ljava/nio/charset/Charset;
...
.method public constructor <init>(Landroid/content/Context;Lg6/b;)V
    ...
    iput-object p2, p0, Lk6/c;->b:Lg6/b;

    new-instance p1, Lk6/e;

    invoke-direct {p1}, Lk6/e;-><init>()V

    iput-object p1, p0, Lk6/c;->c:Lk6/e;
...
.method private f()Ljava/lang/String;
    ...
    :try_start_0
    iget-object v2, p0, Lk6/c;->a:Landroid/content/Context;
    ...
    iget-object v3, p0, Lk6/c;->a:Landroid/content/Context;
    ...
    iget-object v4, p0, Lk6/c;->a:Landroid/content/Context;
...
.method private static k(Ljava/net/HttpURLConnection;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0}, Lk6/c;->o(Ljava/net/HttpURLConnection;)Ljava/lang/String;
    ...
    invoke-static {p1, p2, p3}, Lk6/c;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private l(Ljava/net/URL;Ljava/lang/String;)Ljava/net/HttpURLConnection;
    ...
    iget-object v2, p0, Lk6/c;->b:Lg6/b;
    ...
    invoke-interface {v2}, Le6/i;->a()Lcom/google/android/gms/tasks/Task;
    ...
    :cond_0
    :goto_1
    invoke-direct {p0}, Lk6/c;->f()Ljava/lang/String;
...
.method static m(Ljava/lang/String;)J
    ...
    sget-object v0, Lk6/c;->d:Ljava/util/regex/Pattern;
...
.method private n(Ljava/net/HttpURLConnection;)Lk6/d;
    .locals 5
    ...
    sget-object v2, Lk6/c;->e:Ljava/nio/charset/Charset;
    ...
    invoke-virtual {v2, v3}, Lk6/d$a;->f(Ljava/lang/String;)Lk6/d$a;
    ...
    invoke-virtual {v2, v3}, Lk6/d$a;->c(Ljava/lang/String;)Lk6/d$a;
    ...
    invoke-virtual {v2, v3}, Lk6/d$a;->d(Ljava/lang/String;)Lk6/d$a;
    ...
    invoke-virtual {v1, v3}, Lk6/f$a;->c(Ljava/lang/String;)Lk6/f$a;
    ...
    invoke-static {v3}, Lk6/c;->m(Ljava/lang/String;)J

    move-result-wide v3

    invoke-virtual {v1, v3, v4}, Lk6/f$a;->d(J)Lk6/f$a;
    ...
    invoke-virtual {v2, v3}, Lk6/d$a;->b(Lk6/f;)Lk6/d$a;
    ...
    sget-object p1, Lk6/d$b;->a:Lk6/d$b;

    invoke-virtual {v2, p1}, Lk6/d$a;->e(Lk6/d$b;)Lk6/d$a;

    move-result-object p1

    invoke-virtual {p1}, Lk6/d$a;->a()Lk6/d;
...
.method private static o(Ljava/net/HttpURLConnection;)Ljava/lang/String;
    ...
    sget-object v4, Lk6/c;->e:Ljava/nio/charset/Charset;
...
.method private p(Ljava/net/HttpURLConnection;)Lk6/f;
    .locals 4
    ...
    invoke-virtual {v1, v2}, Lk6/f$a;->c(Ljava/lang/String;)Lk6/f$a;
    ...
    invoke-static {v2}, Lk6/c;->m(Ljava/lang/String;)J

    move-result-wide v2

    invoke-virtual {v1, v2, v3}, Lk6/f$a;->d(J)Lk6/f$a;
    ...
    sget-object p1, Lk6/f$b;->a:Lk6/f$b;

    invoke-virtual {v1, p1}, Lk6/f$a;->b(Lk6/f$b;)Lk6/f$a;

    move-result-object p1

    invoke-virtual {p1}, Lk6/f$a;->a()Lk6/f;
...
.method private q(Ljava/net/HttpURLConnection;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p2, p3}, Lk6/c;->b(Ljava/lang/String;Ljava/lang/String;)Lorg/json/JSONObject;

    move-result-object p2

    invoke-static {p2}, Lk6/c;->h(Lorg/json/JSONObject;)[B

    move-result-object p2

    invoke-static {p1, p2}, Lk6/c;->s(Ljava/net/URLConnection;[B)V
...
.method private r(Ljava/net/HttpURLConnection;)V
    ...
    invoke-static {}, Lk6/c;->c()Lorg/json/JSONObject;

    move-result-object v0

    invoke-static {v0}, Lk6/c;->h(Lorg/json/JSONObject;)[B

    move-result-object v0

    invoke-static {p1, v0}, Lk6/c;->s(Ljava/net/URLConnection;[B)V
...
# virtual methods
.method public d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lk6/d;
    .locals 8

    iget-object v0, p0, Lk6/c;->c:Lk6/e;
    ...
    invoke-direct {p0, v2}, Lk6/c;->g(Ljava/lang/String;)Ljava/net/URL;
    ...
    invoke-direct {p0, v2, p1}, Lk6/c;->l(Ljava/net/URL;Ljava/lang/String;)Ljava/net/HttpURLConnection;
    ...
    :cond_0
    invoke-direct {p0, v4, p2, p4}, Lk6/c;->q(Ljava/net/HttpURLConnection;Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v4}, Ljava/net/HttpURLConnection;->getResponseCode()I

    move-result v5

    iget-object v6, p0, Lk6/c;->c:Lk6/e;

    invoke-virtual {v6, v5}, Lk6/e;->f(I)V

    invoke-static {v5}, Lk6/c;->i(I)Z

    move-result v6

    if-eqz v6, :cond_1

    invoke-direct {p0, v4}, Lk6/c;->n(Ljava/net/HttpURLConnection;)Lk6/d;
    ...
    :cond_1
    :try_start_1
    invoke-static {v4, p4, p1, p3}, Lk6/c;->k(Ljava/net/HttpURLConnection;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_2
    invoke-static {}, Lk6/c;->j()V

    invoke-static {}, Lk6/d;->a()Lk6/d$a;

    move-result-object v5

    sget-object v6, Lk6/d$b;->b:Lk6/d$b;

    invoke-virtual {v5, v6}, Lk6/d$a;->e(Lk6/d$b;)Lk6/d$a;

    move-result-object v5

    invoke-virtual {v5}, Lk6/d$a;->a()Lk6/d;
...
.method public e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lk6/f;
    .locals 7
    ...
    invoke-direct {p0, p2}, Lk6/c;->g(Ljava/lang/String;)Ljava/net/URL;
    ...
    invoke-direct {p0, p2, p1}, Lk6/c;->l(Ljava/net/URL;Ljava/lang/String;)Ljava/net/HttpURLConnection;
    ...
    invoke-direct {p0, v0}, Lk6/c;->r(Ljava/net/HttpURLConnection;)V

    invoke-virtual {v0}, Ljava/net/HttpURLConnection;->getResponseCode()I

    move-result v4

    iget-object v5, p0, Lk6/c;->c:Lk6/e;

    invoke-virtual {v5, v4}, Lk6/e;->f(I)V

    invoke-static {v4}, Lk6/c;->i(I)Z

    move-result v5

    if-eqz v5, :cond_0

    invoke-direct {p0, v0}, Lk6/c;->p(Ljava/net/HttpURLConnection;)Lk6/f;
    ...
    :try_start_1
    invoke-static {v0, v5, p1, p3}, Lk6/c;->k(Ljava/net/HttpURLConnection;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v5, Lk6/f$b;->b:Lk6/f$b;

    invoke-virtual {v4, v5}, Lk6/f$a;->b(Lk6/f$b;)Lk6/f$a;

    move-result-object v4

    :goto_2
    invoke-virtual {v4}, Lk6/f$a;->a()Lk6/f;
    ...
    sget-object v5, Lk6/f$b;->c:Lk6/f$b;
