...
.method public getAccessibilityNodeProvider(Landroid/view/View;)Landroid/view/accessibility/AccessibilityNodeProvider;
    ...
    invoke-virtual {v0, p1}, Landroidx/core/view/a;->b(Landroid/view/View;)Ls/n;

    move-result-object p1

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Ls/n;->a()Ljava/lang/Object;
...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/View;Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-static {p2}, Ls/h;->f0(Landroid/view/accessibility/AccessibilityNodeInfo;)Ls/h;

    move-result-object v0

    invoke-static {p1}, Landroidx/core/view/q0;->H(Landroid/view/View;)Z

    move-result v1

    invoke-virtual {v0, v1}, Ls/h;->b0(Z)V

    invoke-static {p1}, Landroidx/core/view/q0;->E(Landroid/view/View;)Z

    move-result v1

    invoke-virtual {v0, v1}, Ls/h;->Z(Z)V

    invoke-static {p1}, Landroidx/core/view/q0;->l(Landroid/view/View;)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {v0, v1}, Ls/h;->a0(Ljava/lang/CharSequence;)V

    invoke-static {p1}, Landroidx/core/view/q0;->y(Landroid/view/View;)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {v0, v1}, Ls/h;->d0(Ljava/lang/CharSequence;)V

    iget-object v1, p0, Landroidx/core/view/a$a;->a:Landroidx/core/view/a;

    invoke-virtual {v1, p1, v0}, Landroidx/core/view/a;->g(Landroid/view/View;Ls/h;)V

    invoke-virtual {p2}, Landroid/view/accessibility/AccessibilityNodeInfo;->getText()Ljava/lang/CharSequence;

    move-result-object p2

    invoke-virtual {v0, p2, p1}, Ls/h;->d(Ljava/lang/CharSequence;Landroid/view/View;)V
    ...
    check-cast v1, Ls/h$a;

    invoke-virtual {v0, v1}, Ls/h;->b(Ls/h$a;)V
