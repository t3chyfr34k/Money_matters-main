.class public Landroidx/appcompat/widget/c1$c;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/appcompat/widget/c1$c$a;
    }
.end annotation
...
.field private p:Landroidx/appcompat/widget/b1;
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    invoke-static {p1}, Landroidx/appcompat/widget/c1$c$a;->a(Landroid/content/res/Configuration;)I
    ...
    iput v0, p0, Landroidx/appcompat/widget/c1$c;->n:I

    iput v1, p0, Landroidx/appcompat/widget/c1$c;->o:I

    goto :goto_0

    :cond_0
    iput v1, p0, Landroidx/appcompat/widget/c1$c;->n:I

    iput v0, p0, Landroidx/appcompat/widget/c1$c;->o:I
...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/c1$c;->p:Landroidx/appcompat/widget/b1;
    ...
    :cond_1
    iget-object v1, p0, Landroidx/appcompat/widget/c1$c;->q:Landroid/view/MenuItem;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/c1$c;->p:Landroidx/appcompat/widget/b1;

    invoke-interface {v3, v0, v1}, Landroidx/appcompat/widget/b1;->g(Landroidx/appcompat/view/menu/g;Landroid/view/MenuItem;)V

    :cond_2
    iput-object v2, p0, Landroidx/appcompat/widget/c1$c;->q:Landroid/view/MenuItem;

    if-eqz v2, :cond_3

    iget-object v1, p0, Landroidx/appcompat/widget/c1$c;->p:Landroidx/appcompat/widget/b1;

    invoke-interface {v1, v0, v2}, Landroidx/appcompat/widget/b1;->d(Landroidx/appcompat/view/menu/g;Landroid/view/MenuItem;)V
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    iget v2, p0, Landroidx/appcompat/widget/c1$c;->n:I
    ...
    iget v0, p0, Landroidx/appcompat/widget/c1$c;->o:I
...
.method public setHoverListener(Landroidx/appcompat/widget/b1;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/widget/c1$c;->p:Landroidx/appcompat/widget/b1;
