...
# interfaces
.implements Landroidx/window/layout/a0;


# static fields
.field public static final b:Landroidx/window/layout/b0;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Landroidx/window/layout/b0;-><init>()V

    sput-object v0, Landroidx/window/layout/b0;->b:Landroidx/window/layout/b0;
    ...
    sput-object v0, Landroidx/window/layout/b0;->c:Ljava/lang/String;
...
.method private final g(Landroid/view/Display;)Landroid/view/DisplayCutout;
    ...
    :goto_0
    sget-object v0, Landroidx/window/layout/b0;->c:Ljava/lang/String;
...
.method public a(Landroid/app/Activity;)Landroidx/window/layout/y;
    ...
    invoke-virtual {p0, p1}, Landroidx/window/layout/b0;->i(Landroid/view/Display;)Landroid/graphics/Point;
...
.method public b(Landroid/app/Activity;)Landroidx/window/layout/y;
    .locals 2
    ...
    invoke-virtual {p0, p1}, Landroidx/window/layout/b0;->f(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, p1}, Landroidx/window/layout/b0;->e(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, p1}, Landroidx/window/layout/b0;->d(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    :cond_3
    invoke-virtual {p0, p1}, Landroidx/window/layout/b0;->c(Landroid/app/Activity;)Landroid/graphics/Rect;
...
.method public final d(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, v1}, Landroidx/window/layout/b0;->i(Landroid/view/Display;)Landroid/graphics/Point;

    move-result-object v1

    invoke-direct {p0, p1}, Landroidx/window/layout/b0;->h(Landroid/content/Context;)I
...
.method public final e(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    :goto_1
    sget-object v3, Landroidx/window/layout/b0;->c:Ljava/lang/String;

    invoke-static {v3, v1}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/Throwable;)I

    invoke-direct {p0, p1, v0}, Landroidx/window/layout/b0;->j(Landroid/app/Activity;Landroid/graphics/Rect;)V
    ...
    invoke-direct {p0, v1}, Landroidx/window/layout/b0;->g(Landroid/view/Display;)Landroid/view/DisplayCutout;
...
.method public final f(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    :goto_0
    sget-object v1, Landroidx/window/layout/b0;->c:Ljava/lang/String;
